...
export default function Teams({ config }) {
  ...
  return (
  <Section id="teams" title="Participating Teams">
    <div className="container max-w-7xl mx-auto flex flex-wrap gap-6 lg:gap-20 justify-center items-center align-middle">
      {teams.map((s, i) => (
