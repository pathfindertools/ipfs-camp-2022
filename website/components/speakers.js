  ...
  return (
    <div className="mb-4 lg:mb-16">
      <div className="relative w-full mb-4" style={{ paddingTop: "120%"}} >
        <div
          className="absolute -top-0.5 -bottom-0.5 -left-0.5 -right-0.5"
          style={{clipPath: "polygon(50% 0%, 100% 25%, 100% 75%, 50% 100%, 0% 75%, 0% 25%)", "background": "rgb(224,22,51)", "background": "linear-gradient(270deg, rgba(224,22,51,1) 5%, rgba(241,130,0,1) 15%, rgba(246,165,0,1) 20%, rgba(89,217,202,1) 50%, rgba(0,169,229,1) 80%, #045d81 100%)"}}
        />
